...
public interface AreaFacade {
    ...
    /**
     * Updates existing area with new data. Area must exist in order to be
     * updated.
     *
    ...
    /**
     * Retrieves single area based on id given. If area doesn't exist, returns
     * null.
     *
     * @param id id of area
    ...
    /**
     * Changes the area's image.
     *
     * @param imageChange new area's image
     */
