...
<my:template title="Home">
    ...
    <jsp:attribute name="body">
        ...
        <c:if test="${not empty authenticatedAdmin}">
            <b>It's up to you now. Good luck.</b><br/>
            <br/>
            <my:a href="/creature/list">Here</my:a> you can manage creatures. <br/>
            <my:a href="/weapon/list">Here</my:a> you can manage weapons. <br/>
            <my:a href="/area/list">Here</my:a> you can manage areas. <br/>
            <my:a href="/user/list">Here</my:a> you can view users. <br/>
            <br/>
        </c:if>


        <c:if test="${empty authenticatedAdmin}">

            <b>To anyone reading this, I probably won't be alive long enough to tell you:</b><br />
